 ...
 */
public class MTBufferedReader extends Reader {
    ...
    private static int defaultCharBufferSize = 65536;
    private static int defaultExpectedLineLength = 32768;
     ...
     */
    public MTBufferedReader(Reader in, int sz) {
        super(in);
        if (sz <= 0) {
     ...
     * @param in A Reader
     */
    public MTBufferedReader(Reader in) {
    ...
    public String readLine() throws IOException {
        ...
        synchronized (lock) {
            ...
            for (; ; ) {
                ...
                /* Skip last 0x28 left-over */
                if ((cb[nextChar] == (char) 28)) {
                    nextChar++;
                }

                /* Skip 0x27 */
                if ((cb[nextChar] == (char) 27)) {
                    nextChar += 2;
                }
     ...
     *
     * @throws IOException If the stream has never been marked, or if the mark has
     *                     been invalidated
     */
